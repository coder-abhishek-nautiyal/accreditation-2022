...
public class ExceptionConstant {
    ...
    public static final String USER_NAME_ALREADY_EXIST = "User Name is already registered";
    public static final String EMAIL_ID_NOT_EXIST = "Email id doesn't exist";
