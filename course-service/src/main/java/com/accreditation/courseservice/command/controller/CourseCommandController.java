...
public class CourseCommandController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addCourse(@RequestBody CourseCreateRequestDto courseRequestDto)  {
    ...
    @PutMapping("/update")
    public ResponseEntity<?> updateCourse(@RequestBody CourseUpdateRequestDto courseUpdateRequestDto)  {
